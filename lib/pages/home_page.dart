...
import 'package:app_tranporte_users/pages/search_destination_page.dart';
import 'package:app_tranporte_users/pages/trips_history_page.dart';
...
class _HomePageState extends State<HomePage> {
    ...
    tripStreamSubscription =
      ...
      if ((eventSnapshot.snapshot.value as Map)["driverPhone"] != null) {
          ...
          if ((eventSnapshot.snapshot.value as Map)["driverLocation"] != null) {
            double driverLatitude = double.parse((eventSnapshot.snapshot
                .value as Map)["driverLocation"]["latitude"].toString());
            double driverLongitude = double.parse((eventSnapshot.snapshot
                .value as Map)["driverLocation"]["longitude"].toString());
          ...
          if (status == "accepted") {
            ...
            setState(() {
              markerSet.removeWhere((element) =>
                  element.markerId.value.contains("driver"));
            });
          }
          ...
          if (status == "ended") {
            if ((eventSnapshot.snapshot.value as Map)["fareAmount"] != null) {
              double fareAmount = double.parse(
                  (eventSnapshot.snapshot.value as Map)["fareAmount"]
                      .toString());
      ...
      driverCurrentLocationLatLng) async
  {
    if (!requestingDirectionDetailsInfo) {
      ...
      setState(() {
        tripStatusDisplay =
        "Driving to DropOff Location - ${directionDetailsPickup
            .durationTextString}";
      });
